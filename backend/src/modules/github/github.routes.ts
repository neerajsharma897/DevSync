...
import { connectGithubRepo, handleGithubWebhook } from './github.controller.js';
import express from 'express';

// ─── Project-level routes for configuration ──────────────────────────────────
// Mounted at: /api/projects/:projectId/github
...
// If express.json() is used globally, we just use the handler.
