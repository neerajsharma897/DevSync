  ...
  return (
    <div className="h-full p-8 font-sans overflow-y-auto custom-scrollbar">
      <div className="flex items-center justify-between mb-8">
        ...
        <button className="flex items-center px-4 py-2 bg-gray-400 hover:bg-white text-white text-sm font-semibold rounded-lg transition-colors shadow-[0_0_15px_-3px_rgba(37,99,235,0.4)]">
        ...
        <div className="mb-10 bg-gradient-to-r from-gray-700/40 to-gray-700/20 border border-white/30 rounded-2xl p-6 shadow-lg shadow-white/5 relative overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-3">
              <div className="px-2.5 py-1 bg-white/20 border border-white/40 text-gray-300 text-xs font-bold uppercase tracking-wider rounded-md">
                Active Sprint
              </div>
              ...
              <div>
                <div className="flex items-center space-x-3 mb-1.5">
                  ...
                  <span className={clsx(
                    ...
                    sprint.status === 'closed' ? "bg-gray-800 text-gray-500" : "bg-white/10 text-gray-300 border border-white/20"
                  )}>
                    {sprint.status}
                  </span>
                </div>
