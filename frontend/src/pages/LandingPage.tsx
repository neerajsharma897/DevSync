...
export const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-950 font-sans text-gray-200 overflow-hidden selection:bg-white/30">
      
      {/* Navbar */}
      <nav className="fixed top-0 w-full z-50 bg-gray-950/50 backdrop-blur-md border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <div className="w-8 h-8 bg-gradient-to-tr from-gray-300 to-white rounded flex items-center justify-center shadow-lg shadow-white/20">
              <Zap className="w-5 h-5 text-gray-950 fill-current" />
            </div>
            <span className="font-extrabold text-xl tracking-tight text-white">Dev<span className="text-gray-300">Sync</span></span>
          </div>
      ...
      <main className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 px-6">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-5xl h-full pointer-events-none">
          <div className="absolute top-20 left-1/4 w-[500px] h-[500px] bg-white/20 rounded-full blur-[120px] mix-blend-screen" />
          <div className="absolute bottom-20 right-1/4 w-[600px] h-[600px] bg-gray-400/20 rounded-full blur-[150px] mix-blend-screen" />
        </div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold text-white tracking-tight leading-tight mb-8">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-300 via-gray-300 to-gray-300">
              engineering teams.
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            <button onClick={() => navigate('/register')} className="w-full sm:w-auto flex items-center justify-center px-8 py-4 text-base font-bold text-gray-950 bg-gray-300 hover:bg-gray-200 rounded-full transition-all shadow-[0_0_30px_-5px_rgba(16,185,129,0.5)] hover:shadow-[0_0_40px_-5px_rgba(16,185,129,0.7)] hover:-translate-y-1">
      ...
      <section id="features" className="relative z-10 max-w-7xl mx-auto px-6 py-24 border-t border-gray-800/50">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-900/40 border border-gray-800/80 rounded-3xl p-8 hover:bg-gray-900/60 transition-colors relative overflow-hidden">
            ...
            <div className="w-12 h-12 bg-white/10 border border-white/20 rounded-xl flex items-center justify-center mb-6 relative z-10">
      ...
      <footer className="border-t border-gray-900 bg-gray-950 py-12 text-center">
        <div className="flex items-center justify-center space-x-2 mb-4">
          <Zap className="w-5 h-5 text-gray-300 fill-current" />
