            ...
            return (
              <div key={msg.messageId} className="group flex items-start -mx-4 px-4 py-1 hover:bg-gray-900/40 rounded-lg transition-colors">
                ...
                <div className="w-10 flex-shrink-0 flex justify-center">
                  {showHeader ? (
                    <div className="w-9 h-9 rounded-md bg-gradient-to-br from-emerald-500 to-blue-600 flex items-center justify-center text-white font-bold shadow-md">
                ...
                <div className="opacity-0 group-hover:opacity-100 flex items-center space-x-1 bg-gray-900 border border-gray-800 rounded-md p-1 shadow-sm absolute right-6 -mt-3 transition-opacity">
                  <button className="p-1.5 text-gray-400 hover:text-emerald-400 hover:bg-gray-800 rounded"><Smile className="w-4 h-4" /></button>
                  <button className="p-1.5 text-gray-400 hover:text-blue-400 hover:bg-gray-800 rounded"><MessageSquare className="w-4 h-4" /></button>
