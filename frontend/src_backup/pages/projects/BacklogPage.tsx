      ...
      <div className="flex items-center justify-between mb-6 shrink-0">
        <div className="relative w-72">
          ...
          <input 
            ...
            className="w-full bg-gray-900 border border-gray-800 rounded-lg pl-9 pr-4 py-2 text-sm text-gray-200 focus:outline-none focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/50 transition-all"
          />
        </div>
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar">
          {isLoading ? (
            ...
            tasks.map((task) => (
              ...
              >
                {/* Key */}
                <div className="col-span-1 text-sm font-mono text-gray-500 group-hover:text-blue-400 transition-colors">
                  {task.taskKey}
                </div>
                ...
                <div className="col-span-2">
                  <span className={clsx(
                    ...
                    task.status === 'IN_REVIEW' ? "bg-purple-500/10 text-purple-400" :
                ...
                <div className="col-span-2 flex items-center">
                  {task.assigneeId ? (
                    <div className="w-6 h-6 rounded-full bg-emerald-500 flex items-center justify-center text-[10px] font-bold text-white shadow-sm border border-gray-900">
                      U
                    </div>
                  ) : (
